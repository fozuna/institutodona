...
<div class="p-6 max-w-3xl">
  <div class="flex justify-between items-center mb-4">
    <h1 class="text-2xl font-bold"><?= htmlspecialchars($pageTitle ?? 'Novo Coaching') ?></h1>
  ...
  <div class="bg-white shadow rounded p-4">
    <form method="post" action="index.php?route=coaching/store" class="space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="md:col-span-2">
          ...
          <input class="border rounded p-2 w-full" type="text" name="coach" />
        </div>
        <div class="md:col-span-2">
          <label class="block text-sm">Observações</label>
          <textarea class="border rounded p-2 w-full" name="observacoes" rows="3"></textarea>
        </div>
        <div>
