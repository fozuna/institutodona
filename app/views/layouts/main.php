        ...
        <?php if ($user): ?>
            ...
            <aside class="w-72 shrink-0 bg-brand-brown text-white fixed h-screen desktop:relative desktop:block flex flex-col">
                ...
                <nav class="px-4 py-4 space-y-1">
                    ...
                    <a class="block px-3 py-2 rounded nav-link" href="index.php?route=aplicacoes/create"><span data-feather="plus-square" class="inline-block mr-2"></span>Aplicar Tarefa</a>
                </nav>
