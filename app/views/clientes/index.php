        ...
        <table class="min-w-full">
            ...
            <tbody>
                <?php foreach ($items as $c): ?>
                    <?php $clienteAtivo = !isset($c['ativo']) || (int)$c['ativo'] === 1; ?>
                    <tr class="border-b">
                        ...
                        <td class="p-3">
                            <?php if ($clienteAtivo): ?>
                                <span class="inline-flex px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700">Ativo</span>
                            <?php else: ?>
                                <span class="inline-flex px-3 py-1 rounded-full text-xs font-medium bg-gray-200 text-gray-700">Inativo</span>
                            <?php endif; ?>
                        </td>
                        <td class="p-3">
