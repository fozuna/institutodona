<?php use App\Core\Security; /** @var array $departamentos */ /** @var array $setores */ /** @var array $funcoes */ /** @var int $cliente */ ?>
...
<div class="p-6 max-w-xl">
    ...
    <form method="post" action="index.php?route=colaboradores/store" class="space-y-4" data-colaboradores-form>
